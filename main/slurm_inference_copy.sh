...
mkdir /scratch/aparna/demo/ASL/images/${base_parent}
mkdir /scratch/aparna/demo/ASL/results/${base_parent}
echo  $base_parent
IMG_PATH=/scratch/aparna/demo/ASL/images/${base_parent}/${INPUT_VIDEO}
SAVE_DIR=/scratch/aparna/demo/ASL/results/${base_parent}/${INPUT_VIDEO}
echo $SAVE_DIR
# video to images
#mkdir $IMG_PATH
#mkdir $SAVE_DIR
