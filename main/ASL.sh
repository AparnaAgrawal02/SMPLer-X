...
directory="/ssd_scratch/cvit/aparna/ASL"
#for folder in $directory/* ; do 
	#echo $folder
#for filename in $directory/video/train/* ; do
#	echo $filename  $folder
sh slurm_inference_final.sh  $directory  mp4 24 smpler_x_l32
	#done
#done  
#for folder in $directory/* ; do
#        echo $folder
...
#                echo $filename  $folder
#		 sh slurm_inference_copy.sh  $filename  mp4 24 smpler_x_l32
#        done
#done
